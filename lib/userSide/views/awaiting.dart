                            ...
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  ListTile(
                                    title: Text(
                                        "Your Order ${accessoryType} with size {$measure} is placed successfully "),
                                    // trailing: PickBy == "" ? Text("Add to List",style: TextStyle(color: Colors.green),) :  null,
                                    subtitle: quotation == false
                                        ? const Text("Waiting for Quotation")
                                        : Text(
                                            "The price of this prodcut is ${price}"),
                                  ),
